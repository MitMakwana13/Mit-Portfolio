    ...
    <section className="py-24 md:py-32 px-6 md:px-12 lg:px-24 bg-background border-t border-foreground/5">
      <div className="max-w-7xl mx-auto">
        <header className="mb-20">
          <h2 className="text-muted uppercase tracking-[0.2em] text-xs font-mono mb-4">Proof I can build</h2>
          ...
          <div className={`grid grid-cols-1 md:grid-cols-3 gap-6 ${inView ? 'animate-fade-up' : 'reveal-hidden'}`}>
            {credentials.map((cred, idx) => (
              ...
              >
                ...
                <h3 className="text-lg font-bold text-foreground mb-3 leading-tight group-hover:text-accent transition-colors duration-300">
                  {cred.title}
                </h3>
